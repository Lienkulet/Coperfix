    ...
    <section className="py-24 bg-bone">
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
        <div className="text-center max-w-2xl mx-auto">
          ...
          >
            Let&apos;s talk about<br />
            <span style={{ fontFamily: "var(--font-serif)", fontStyle: "italic", textTransform: "none", color: "#C7252A" }}>your project.</span>
          </h2>

          <p className="text-gray-700 leading-relaxed mx-auto mb-8" style={{ fontSize: "1.05rem", maxWidth: "560px" }}>
            Free estimates, honest recommendations, and a direct line to Rafael. No middlemen, no pressure.
          </p>
