...
const CHECKLIST = [
  "Full tear off & underlayment inspection",
  "Architectural shingle install",
  "Built to last in Oregon weather",
];
        ...
        <div className="grid gap-16 items-center" style={{ gridTemplateColumns: "repeat(auto-fit, minmax(min(100%, 440px), 1fr))" }}>
          ...
          <div>
            ...
            <p className="text-gray-700 leading-[1.7] mb-4 max-w-[480px]" style={{ fontSize: "1rem" }}>
              This Beaverton home came to us with a tired, weathered roof at the end of its life. We tore off
              the old layer, addressed every soft spot underneath, and installed fresh architectural shingles
              built to handle decades of Oregon weather.
            </p>
            <p className="text-gray-700 leading-[1.7]" style={{ fontSize: "1rem" }}>
              Watch the transformation in real time. Same house, completely new top.
            </p>
