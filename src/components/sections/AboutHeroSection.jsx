      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 relative">
        ...
        >
          <div>
            ...
            >
              A family.<br />
              <span style={{ fontFamily: "var(--font-serif)", fontStyle: "italic", textTransform: "none", color: "#C7252A" }}>A craft.</span><br />
              A local promise.
            </h1>

            <p className="text-gray-700 leading-relaxed" style={{ fontSize: "1.1rem", maxWidth: "520px" }}>
              R &amp; D Perez Construction is a family owned exterior contractor based in Beaverton, Oregon. We build roofs, decks, fences, and masonry, and we do it the way our name is on every job: personally.
            </p>
          </div>
