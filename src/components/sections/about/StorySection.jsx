      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
        ...
        >
          ...
          <div>
            ...
            >
              Am fondat Coperfix pentru că credem că lucrările de exterior — copertine pentru terase, balcoane, garduri, parcari auto — trebuie făcute <em style={{ fontStyle: "italic", color: "#c9a14e" }}>bine</em>, de oameni cărora le pasă cu adevărat de rezultat.
            </p>
            ...
            <p className="text-gray-700 leading-relaxed mb-5" style={{ fontSize: "1.02rem", lineHeight: 1.8 }}>
              Ne specializăm în <strong style={{ color: "#161a1e", fontWeight: 600 }}>copertine pentru terase, balcoane, garduri, parcari auto</strong>. Fie că este vorba de o copertină nouă, o terasă acoperită, un gard complet sau o pergolă bioclimatică, o facem cu aceeași precizie și responsabilitate.
            </p>
