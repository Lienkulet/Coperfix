...
const TRIO = [
  { src: "/rd-drone-4.jpg",  alt: "Dark architectural shingle roof replacement",   caption: "Roofing" },
  { src: "/rd-drone-1.jpg",  alt: "Wraparound composite deck with fire pit",        caption: "Decks"   },
  { src: "/chimney-1.jpg",   alt: "Red brick chimney rebuild",                      caption: "Masonry" },
];
...
export default function AboutTrioSection() {
  return (
    <section className="py-24 bg-bone">
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
        <div className="text-center mb-12">
          ...
          >
            Every project,<br />
            <span style={{ fontFamily: "var(--font-serif)", fontStyle: "italic", textTransform: "none", color: "#C7252A" }}>our name on it.</span>
          </h2>
        </div>
