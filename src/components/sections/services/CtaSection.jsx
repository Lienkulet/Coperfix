      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
        <div className="text-center max-w-2xl mx-auto">
          ...
          >
            Nu știi de unde<br />
            să începi?{" "}
            <span style={{ fontFamily: "var(--font-serif)", fontStyle: "italic", textTransform: "none", color: "#c9a14e" }}>Întreabă-ne.</span>
          </h2>

          <p className="text-gray-700 leading-relaxed mx-auto mb-10" style={{ fontSize: "1.05rem", maxWidth: "480px" }}>
            Sună-ne direct sau lasă un mesaj. Ne ocupăm de restul.
          </p>
